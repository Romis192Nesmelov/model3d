...
//        'string'  => 'Строка :attribute должна состоять не менее чем из :min символов.',
    ...
    'action_time_start_error' => 'Время старта акции не может быть больше или равно времени ее конца.',
    'action_time_end_error' => 'Время окончания акции не может быть меньше времени ее начаоа.',
